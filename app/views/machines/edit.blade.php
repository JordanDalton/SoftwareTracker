            ...
            <div class="col-lg-6">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    {{ Form::model( $machine , ['method' => 'PATCH', 'role' => 'form', 'route' => ['machines.update', $machine->id]] ) }}
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('department_id') ? 'has-error' : '' }}">
                                ...
                                @if( $errors->has('department_id') )
                                    {{ Form::select('department_id', $departments_dropdown , $department_preselect, ['class' => 'form-control alert-danger'])}}
                                    {{ $errors->first('department_id', '<span class="help-block">:message</span>') }}
                                @else
                                    {{ Form::select('department_id', $departments_dropdown , $department_preselect, ['class' => 'form-control'])}}
                                @endif
